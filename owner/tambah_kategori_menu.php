                    ...
                    <div class="card my-4 mx-3">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Tambah Kategori Menu</h6>
                            </div>
                        </div>
                        <div class="card-body px-4 pb-2">
                            <p>Icon kategori diambil dari <a class="text-primary" href="https://fonts.google.com/icons" target="_blank">Font Google</a></p>
                            <form method="post" action="<?= $base_url; ?>/owner/proses_tambah_kategori_menu.php">
                                <div class="row">
                                    <div class="col-md-6 my-3">
                                        <label for="exampleFormControlInput1" class="form-label">nama kategori menu</label>
                                        <div class="input-group input-group-outline">
                                            <input type="text" name="nama" class="form-control " id="exampleFormControlInput1" placeholder="nama kategori menu">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 my-3">
                                        ...
                                        <div class="input-group input-group-outline">
                                            <input type="text" name="icon" class="form-control" id="exampleFormControlInput1" placeholder="icon kategori menu">
                                        </div>
                                    </div>
